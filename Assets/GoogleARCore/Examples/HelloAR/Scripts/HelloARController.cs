...
namespace GoogleARCore.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
		...
		private bool sceneIntantiate = false;
		/// <summary>
		/// A prefab for Arrow
		/// </summary>
        ...
        public void Update()
        {
            ...
            if (Input.touchCount < 1 || (touch = Input.GetTouch(0)).phase != TouchPhase.Began){
				...
				StartCoroutine(Shoot());
			}else if(!sceneIntantiate) {
				canShoot = true;
				sceneIntantiate = true;
		...
		IEnumerator Shoot() {
			canShoot = false;
			Instantiate(ArrowPrefab, FirstPersonCamera.transform).transform.parent = null;
